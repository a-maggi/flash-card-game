...
const Icon: React.FC<IconProps> = (props) => (
    ...
    >
        ...
        ></path>
        <path fill="#E75A70" d="M18 19.5c3 0 3 .5 3 1.5s-1.5 3-3 3-3-2-3-3-.001-1.5 3-1.5z"></path>
        <path
            fill="#F18F26"
        ...
        <path
            fill="#FEE7B8"
            d="M.701 25a.5.5 0 01-.31-.892c.162-.127 4.02-3.12 10.648-2.605.275.02.481.261.46.536-.021.275-.257.501-.537.46-6.233-.474-9.915 2.366-9.951 2.395a.51.51 0 01-.31.106zm8.868-4.663a.512.512 0 01-.149-.022c-4.79-1.497-8.737-.347-8.777-.336a.499.499 0 11-.288-.957c.173-.052 4.286-1.247 9.362.338a.5.5 0 01-.148.977zM35.299 25a.5.5 0 00.31-.892c-.162-.127-4.02-3.12-10.648-2.605a.499.499 0 00-.46.536c.021.275.257.501.537.46 6.233-.474 9.915 2.366 9.951 2.395a.51.51 0 00.31.106zm-8.868-4.663c.049 0 .1-.007.149-.022 4.79-1.497 8.737-.347 8.777-.336a.499.499 0 10.288-.957c-.173-.052-4.286-1.247-9.362.338a.5.5 0 00.148.977z"
        ></path>
        <path
            fill="#292F33"
